<?php   										// Opening PHP tag
	...
	function get_toy(PDO $pdo, string $id) {
		...
		$sql = "SELECT toy.toynum AS toynum, toy.name AS toyname, toy.price AS price, toy.agerange AS agerange, toy.numinstock AS stock, toy.description AS description, toy.imgSrc AS imgSrc, manuf.name AS manuname, manuf.Street AS Street, manuf.City AS City, manuf.State AS State, manuf.ZipCode AS ZipCode, manuf.phone AS phone, manuf.contact AS contact
		FROM 
			toy
		JOIN 
			manuf 
		...
		<main>
			...
			<div class="toy-details-container">
				...
				<div class="toy-details">
			        ...
			        <p><strong>Name:</strong> <?= $toy['manuname'] ?> </p>
